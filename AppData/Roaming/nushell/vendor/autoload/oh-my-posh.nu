$env.POSH_THEME = "C:/Users/Admin/.config/oh-my-posh.json"
...
$env.POSH_SESSION_ID = "8bd16e1c-3668-4b4c-8ea2-2912d4c804ac"
$env.POSH_SHELL = "nu"
...
let _omp_executable: string = (echo "C:/Users/Admin/AppData/Local/Microsoft/WindowsApps/oh-my-posh.exe")
...
def --wrapped _omp_get_prompt [
    ...
    (
        ^$_omp_executable print $type --config=C:/Users/Admin/.config/oh-my-posh.json
            --save-cache
            --shell=nu
...
$env.PROMPT_MULTILINE_INDICATOR = (
    ^$_omp_executable print secondary --config=C:/Users/Admin/.config/oh-my-posh.json
        --shell=nu
        $"--shell-version=($env.POSH_SHELL_VERSION)"
)
